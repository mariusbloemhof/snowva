...
export const customers: Customer[] = [
  ...
  { id: 'cust_004', name: 'Sportsmans Warehouse', type: CustomerType.B2B, vatNumber: '4080304928', legalEntityName: 'Sportsmans Warehouse Holdings (Pty) Ltd', contactPerson: 'Head Office', contactEmail: 'hq@swarehouse.co.za', contactPhone: '021-555-0104', addresses: [{ id: 'addr_004', type: 'billing', isPrimary: true, addressLine1: 'PO Box 2721', city: 'Cape Town', postalCode: '8000', province: 'Western Cape', country: 'South Africa' }], defaultInvoiceNotes: 'A valid PO number must be referenced on the invoice.', paymentTerm: PaymentTerm.DAYS_60,
  ...
  { id: 'cust_009', name: 'Trans Africa Self drive adventures & Tours', type: CustomerType.B2B, vatNumber: '4567890123', contactEmail: 'bookings@transafrica.com', addresses: [{ id: 'addr_009', type: 'delivery', isPrimary: true, addressLine1: '7 Hill street', city: 'Keurboomstrand', postalCode: '6600', province: 'Western Cape', country: 'South Africa' }], paymentTerm: PaymentTerm.DAYS_30 },
  { id: 'cust_010', name: 'Obaro', type: CustomerType.B2B, vatNumber: '4880101867', contactEmail: 'info@obaro.co.za', addresses: [{ id: 'addr_010', type: 'billing', isPrimary: true, addressLine1: '26 Lood St', suburb: 'Isando', city: 'Kempton Park', postalCode: '1600', province: 'Gauteng', country: 'South Africa' }], paymentTerm: PaymentTerm.EOM_30 },
  { id: 'cust_011', name: 'Obaro - Brits', type: CustomerType.B2B, parentCompanyId: 'cust_010', branchNumber: 'OB01', contactEmail: 'brits@obaro.co.za', addresses: [{ id: 'addr_011', type: 'delivery', isPrimary: true, addressLine1: '1 Industria St', city: 'Brits', postalCode: '0250', province: 'North West', country: 'South Africa' }], invoiceLevel: 'branch' },
  { id: 'cust_012', name: 'Obaro - Dwaalboom', type: CustomerType.B2B, parentCompanyId: 'cust_010', branchNumber: 'OB02', contactEmail: 'dwaalboom@obaro.co.za', addresses: [{ id: 'addr_012', type: 'delivery', isPrimary: true, addressLine1: 'Main Rd', city: 'Dwaalboom', postalCode: '0386', province: 'Limpopo', country: 'South Africa' }], invoiceLevel: 'branch' },
  { id: 'cust_013', name: 'Outdoor Warehouse', type: CustomerType.B2B, vatNumber: '4430177198', contactEmail: 'support@odw.co.za', addresses: [{ id: 'addr_013', type: 'billing', isPrimary: true, addressLine1: '1 Outdoor Way', city: 'Cape Town', postalCode: '8001', province: 'Western Cape', country: 'South Africa' }], paymentTerm: PaymentTerm.DAYS_30 },
  { id: 'cust_014', name: 'Outdoor Warehouse - Alberton', type: CustomerType.B2B, parentCompanyId: 'cust_013', contactEmail: 'alberton@odw.co.za', addresses: [{ id: 'addr_014', type: 'delivery', isPrimary: true, addressLine1: 'New Redruth Village', suburb: 'New Redruth', city: 'Alberton', postalCode: '1449', province: 'Gauteng', country: 'South Africa' }], invoiceLevel: 'branch' },
  { id: 'cust_015', name: 'Outdoor Warehouse - Ballito', type: CustomerType.B2B, parentCompanyId: 'cust_013', contactEmail: 'ballito@odw.co.za', addresses: [{ id: 'addr_015', type: 'delivery', isPrimary: true, addressLine1: 'Lifestyle Centre', city: 'Ballito', postalCode: '4420', province: 'KwaZulu-Natal', country: 'South Africa' }], invoiceLevel: 'branch' },
];
...
export const payments: Payment[] = [
  ...
  { id: 'pay_003', customerId: 'cust_004', date: '2024-12-01', totalAmount: 1520.00, method: PaymentMethod.EFT, reference: 'SW Head Office INV 241007101', allocations: [{ invoiceId: 'inv_003', amount: 1520.00 }] },
];
...
export const invoices: Invoice[] = [
    ...
    { id: 'inv_003', invoiceNumber: '241007101', customerId: 'cust_005', date: '2024-10-07', dueDate: '2024-12-06', items: [{id: 'li_005', productId: 'prod_001', description: 'Snowva Ultimate Ice Maker', quantity: 1, unitPrice: 1520.00 / 1.15}], status: DocumentStatus.PAID, notes: 'PO #12345' },
