...
import { Customer, Product, Invoice, Quote, CustomerType, DocumentStatus, LineItem, Address, Payment, PaymentMethod } from './types';

export const VAT_RATE = 0.15;

export const customers: Customer[] = [
  { id: 'cust_001', name: '4 Seasons Winkel', type: CustomerType.B2B, vatNumber: '4123456789', contactPerson: 'John Doe', contactEmail: 'accounts@4seasons.co.za', contactPhone: '021-555-0101', addresses: [{ id: 'addr_001', type: 'delivery', isPrimary: true, street: '123 Main Rd', city: 'Cape Town', postalCode: '8001', province: 'Western Cape' }] },
  { id: 'cust_002', name: '4X4 Unlimited Pty Ltd', type: CustomerType.B2B, vatNumber: '4234567890', contactPerson: 'Jane Smith', contactEmail: 'info@4x4unlimited.co.za', contactPhone: '011-555-0102', addresses: [{ id: 'addr_002', type: 'delivery', isPrimary: true, street: '4x4 Adventure Lane', city: 'Johannesburg', postalCode: '2001', province: 'Gauteng' }] },
  { id: 'cust_003', name: 'A&A Business Services Pty Ltd', type: CustomerType.B2B, vatNumber: '4345678901', contactPerson: 'Peter Jones', contactEmail: 'contact@aabusiness.co.za', contactPhone: '031-555-0103', addresses: [{ id: 'addr_003', type: 'delivery', isPrimary: true, street: '1 Service St', city: 'Durban', postalCode: '4001', province: 'KwaZulu-Natal' }] },
  ...
  { id: 'cust_005', name: 'Sportsmans Warehouse - Atterbury', type: CustomerType.B2B, parentCompanyId: 'cust_004', branchNumber: 'SW01', contactEmail: 'atterbury@swarehouse.co.za', addresses: [{ id: 'addr_005', type: 'delivery', isPrimary: true, street: 'Atterbury Value Mart', city: 'Pretoria', postalCode: '0081', province: 'Gauteng' }], invoiceLevel: 'branch',
    customProductPricing: [
      {
        id: 'cpp_002',
  ...
  { id: 'cust_006', name: 'Sportsmans Warehouse - Ballito', type: CustomerType.B2B, parentCompanyId: 'cust_004', branchNumber: 'SW02', contactEmail: 'ballito@swarehouse.co.za', addresses: [{ id: 'addr_006', type: 'delivery', isPrimary: true, street: 'Ballito Junction', city: 'Ballito', postalCode: '4420', province: 'KwaZulu-Natal' }], invoiceLevel: 'branch' },
  ...
  { id: 'cust_009', name: 'Trans Africa Self drive adventures & Tours', type: CustomerType.B2B, vatNumber: '4567890123', contactEmail: 'bookings@transafrica.com', addresses: [{ id: 'addr_009', type: 'delivery', isPrimary: true, street: '7 Hill street', city: 'Keurboomstrand', postalCode: '6600', province: 'Western Cape' }] },
  { id: 'cust_010', name: 'Obaro', type: CustomerType.B2B, vatNumber: '4880101867', contactEmail: 'info@obaro.co.za', addresses: [{ id: 'addr_010', type: 'billing', isPrimary: true, street: '26 Lood St', city: 'Isando', postalCode: '1600', province: 'Gauteng' }] },
  ...
  { id: 'cust_013', name: 'Outdoor Warehouse', type: CustomerType.B2B, vatNumber: '4430177198', contactEmail: 'support@odw.co.za', addresses: [{ id: 'addr_013', type: 'billing', isPrimary: true, street: '1 Outdoor Way', city: 'Cape Town', postalCode: '8001', province: 'Western Cape' }] },
...
const payment1: Payment = { id: 'pay_001', date: '2025-07-10', amount: 750.00, method: PaymentMethod.EFT, reference: 'H.Coetzee Inv 250707101' };
const payment2_part1: Payment = { id: 'pay_002', date: '2025-09-01', amount: 10000.00, method: PaymentMethod.EFT };

export const invoices: Invoice[] = [
    { id: 'inv_001', invoiceNumber: '250707101', customerId: 'cust_008', date: '2025-07-07', items: sampleLineItems1, status: DocumentStatus.PAID, payments: [payment1] },
    { id: 'inv_002', invoiceNumber: '250827101', customerId: 'cust_009', date: '2025-08-27', orderNumber: '#270801', items: sampleLineItems2, status: DocumentStatus.PARTIALLY_PAID, payments: [payment2_part1] },
    { id: 'inv_003', invoiceNumber: '241007101', customerId: 'cust_005', date: '2024-10-07', items: [{id: 'li_005', productId: 'prod_001', description: 'Snowva Ultimate Ice Maker', quantity: 1, unitPrice: 1520.00 / 1.15}], status: DocumentStatus.FINALIZED, notes: 'PO #12345', payments: [] },
    { id: 'inv_004', invoiceNumber: 'DRAFT-001', customerId: 'cust_001', date: new Date().toISOString().split('T')[0], items: [], status: DocumentStatus.DRAFT, payments: [] },
];
