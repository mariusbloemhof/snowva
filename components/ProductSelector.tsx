    ...
    <div className="relative w-full" ref={wrapperRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full p-2 pl-8 border border-ui-stroke rounded-md shadow-sm focus:outline-none focus:ring-snowva-blue focus:border-snowva-blue"
          autoComplete="off"
        />
      </div>
      {isOpen && (
          ...
          {filteredProducts.length > 0 ? (
            filteredProducts.map(product => (
              <li
                ...
                className="px-4 py-2 cursor-pointer hover:bg-snowva-blue hover:text-white"
              >
                {product.name}
              </li>
            ))
